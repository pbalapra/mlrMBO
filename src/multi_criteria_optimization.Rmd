...
init.points.num = 5 * sum(ParamHelpers::getParamLengths(smoof::getParamSet(obj))) # 5 times the total dimension 
design1 = generateDesign(n = init.points.num, par.set = smoof::getParamSet(obj), fun=maximinLHS, fun.args = list(k=2))
```
